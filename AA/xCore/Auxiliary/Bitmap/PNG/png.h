...
PNG_EXPORT_VAR (char) xpng_libxpng_ver[12];   /* need room for 99.99.99aa */
#else
...
PNG_EXPORT_VAR (int FARDATA) xpng_pass_start[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_inc[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_ystart[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_yinc[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_mask[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_dsp_mask[7];
/* These aren't currently used.  If you need them, see png.c for more details
PNG_EXPORT_VAR (int FARDATA) xpng_pass_width[7];
PNG_EXPORT_VAR (int FARDATA) xpng_pass_height[7];
*/
#endif
 ...
 * of sPLT chunks.
 */
typedef struct xpng_spalette_entry_struct
{
   xpng_uint_16 red;
   xpng_uint_16 green;
   xpng_uint_16 blue;
...
typedef xpng_spalette_entry FAR * xpng_spalette_entryp;
typedef xpng_spalette_entry FAR * FAR * xpng_spalette_entrypp;

typedef struct xpng_spalette_struct
{
   xpng_charp name;                /* palette name */
   xpng_byte depth;                /* depth of palette samples */
   xpng_spalette_entryp entries;        /* palette entries */
   xpng_int_32 nentries;                /* number of palette entries */
} xpng_spalette;
typedef xpng_spalette FAR * xpng_spalette_p;
typedef xpng_spalette FAR * FAR * xpng_spalette_pp;
...
typedef struct xpng_text_struct
{
   ...
   xpng_charp lang;         /* language code, 1-79 characters */
 ...
 * members go through the corresponding xpng_set_* functions.  Functions to
 * clear these members are available: see xpng_free_*.  The xpng_set_* functions
 ...
 * xpng_set_text function uses the same storage passed to them
...
typedef struct xpng_info_struct
{
   ...
   xpng_byte channels;       /* number of data channels per pixel (1, 3, 4)*/
...
#endif
   xpng_fixed_point int_gamma; /* gamma value of image, if (valid & PNG_INFO_gAMA) */
#endif
   ...
   xpng_textp text_old; /* array of comments read/to write, backward
...
typedef void (*xpng_error_ptr) PNGARG((xpng_structp, xpng_const_charp));
typedef void (*xpng_rw_ptr) PNGARG((xpng_structp, xpng_bytep, xpng_size_t));
typedef void (*xpng_flush_ptr) PNGARG((xpng_structp));
typedef void (*xpng_read_status_ptr) PNGARG((xpng_structp, xpng_uint_32, int));
typedef void (*xpng_write_status_ptr) PNGARG((xpng_structp, xpng_uint_32, int));

#ifdef PNG_PROGRESSIVE_READ_SUPPORTED
typedef void (*xpng_progressive_info_ptr) PNGARG((xpng_structp, xpng_infop));
typedef void (*xpng_progressive_end_ptr) PNGARG((xpng_structp, xpng_infop));
typedef void (*xpng_progressive_row_ptr) PNGARG((xpng_structp, xpng_bytep,
   xpng_uint_32, int));
#endif

#if defined(PNG_READ_USER_TRANSFORM_SUPPORTED) || \
    defined(PNG_WRITE_USER_TRANSFORM_SUPPORTED)
typedef void (*xpng_user_transform_ptr) PNGARG((xpng_structp,
    xpng_row_infop, xpng_bytep));
#endif

#if defined(PNG_READ_USER_CHUNKS_SUPPORTED)
typedef int (*xpng_user_chunk_ptr) PNGARG((xpng_structp, xpng_unknown_chunkp));
#endif
#if defined(PNG_READ_UNKNOWN_CHUNKS_SUPPORTED)
typedef void (*xpng_unknown_chunk_ptr) PNGARG((xpng_structp));
#endif
...
/* for the Borland special 64K segment handler */
   ...
   xpng_byte rgb_to_gray_red_coeff;
   xpng_byte rgb_to_gray_green_coeff;
   xpng_byte rgb_to_gray_blue_coeff;
#endif

#if defined(PNG_READ_EMPTY_PLTE_SUPPORTED) || \
    defined(PNG_WRITE_EMPTY_PLTE_SUPPORTED)
   xpng_byte empty_plte_permitted;
#endif
...
/* This prevents a compiler error in xpng_get_copyright() in png.c if png.c
and png.h are both at * version 1.0.5m
 */
typedef xpng_structp version_1_0_5m;
...
extern void xpng_info_init PNGARG((xpng_infop info_ptr));
...
extern void xpng_write_destroy_info PNGARG((xpng_infop info_ptr));
...
extern PNG_EXPORT(void,xpng_init_io) PNGARG((xpng_structp xpng_ptr, FILE *fp));
#endif
...
extern PNG_EXPORT(xpng_uint_32, xpng_get_x_offset_pixels) PNGARG((xpng_structp
xpng_ptr, xpng_infop info_ptr));
extern PNG_EXPORT(xpng_uint_32, xpng_get_y_offset_pixels) PNGARG((xpng_structp
xpng_ptr, xpng_infop info_ptr));
extern PNG_EXPORT(xpng_uint_32, xpng_get_x_offset_microns) PNGARG((xpng_structp
xpng_ptr, xpng_infop info_ptr));
extern PNG_EXPORT(xpng_uint_32, xpng_get_y_offset_microns) PNGARG((xpng_structp
xpng_ptr, xpng_infop info_ptr));
...
#if defined(PNG_pCAL_SUPPORTED)
extern PNG_EXPORT(void,xpng_free_pCAL) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr));
#endif
...
extern PNG_EXPORT(void,xpng_free_iCCP) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr));
#endif

#if defined(PNG_READ_sPLT_SUPPORTED)
extern PNG_EXPORT(xpng_uint_32,xpng_get_spalettes) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, xpng_spalette_pp entries));
#endif

#if defined(PNG_sPLT_SUPPORTED)
extern PNG_EXPORT(void,xpng_set_spalettes) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, xpng_spalette_p entries, int nentries));
extern PNG_EXPORT(void,xpng_free_spalettes) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, int num));
#endif

#if defined(PNG_READ_iTXt_SUPPORTED)
/* xpng_get_itxt also returns the number of text chunks in *num_text */
extern PNG_EXPORT(xpng_uint_32,xpng_get_itxt) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, xpng_textp *text_ptr, int *num_text));
#endif

#if defined(PNG_TEXT_SUPPORTED)
extern PNG_EXPORT(void,xpng_set_itxt) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, xpng_textp text_ptr, int num_text));
#endif

#if defined(PNG_READ_TEXT_SUPPORTED)
/* Old interface; apps should use xpng_get_itxt instead */
...
extern PNG_EXPORT(void,xpng_set_text) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, xpng_textp text_ptr, int num_text));
extern PNG_EXPORT(void,xpng_free_text) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, int num_text_old));
#endif
...
#if defined(PNG_tRNS_SUPPORTED)
extern PNG_EXPORT(void,xpng_free_tRNS) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr));
#endif
...
extern PNG_EXPORT(void,xpng_free_sCAL) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr));
#endif /* PNG_READ_sCAL_SUPPORTED || PNG_WRITE_sCAL_SUPPORTED */
...
extern PNG_EXPORT(void,xpng_free_unknown_chunks) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr, int num));
...
extern PNG_EXPORT(void,xpng_free_chunk_list) PNGARG((xpng_structp xpng_ptr));
#endif
...
extern PNG_EXPORT(void, xpng_write_png) PNGARG((xpng_structp xpng_ptr,
						...
						int transforms,
						voidp params));
extern PNG_EXPORT(void, xpng_free_pixels) PNGARG((xpng_structp xpng_ptr,
					      xpng_infop info_ptr));
#endif
...
#define xpng_debug(l,m)        if (PNG_DEBUG > l) \
                                 fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))))
#define xpng_debug1(l,m,p1)    if (PNG_DEBUG > l) \
                                 fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1)
#define xpng_debug2(l,m,p1,p2) if (PNG_DEBUG > l) \
                                 fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1,p2)
#endif /* (PNG_DEBUG > 0) */
#endif /* PNG_DEBUG */
...
extern PNG_EXPORT(xpng_bytep,xpng_sig_bytes) PNGARG((xpng_structp xpng_ptr));
...
#ifdef PNG_USE_GLOBAL_ARRAYS
   PNG_EXPORT_VAR (xpng_byte FARDATA) xpng_sig[8];
#else
 ...
 */
extern void xpng_read_init PNGARG((xpng_structp xpng_ptr));

/* Initialize xpng_ptr struct for writing, and allocate any other memory.
 * (old interface - NOT DLL EXPORTED).
 */
extern void xpng_write_init PNGARG((xpng_structp xpng_ptr));
...
#if defined(PNG_hIST_SUPPORTED)
extern PNG_EXPORT(void,xpng_free_hIST) PNGARG((xpng_structp xpng_ptr,
   xpng_infop info_ptr));
#endif
...
PNG_EXTERN void xpng_write_oFFs PNGARG((xpng_structp xpng_ptr,
   xpng_uint_32 x_offset, xpng_uint_32 y_offset, int unit_type));
#endif
...
PNG_EXTERN int xpng_handle_as_unknown PNGARG((xpng_structp xpng_ptr, xpng_bytep
   chunk_name));
#endif
