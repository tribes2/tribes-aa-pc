...
f32 player_object::SPAM_MAX_TIME      = 5.0f ;    // Max time between taunting
...
audio_to_message Messages[] =
{
    { "",                                             0   ,0 },
    { "Attack!",                                      1   ,0 },
    { "Attack the enemy base!",                       2   ,0 },
    { "Recover our flag!",                            3   ,MSG_AUTO_RECOVER_FLAG },
    { "Disrupt the enemy defense!",                   4   ,0 },
    { "Get the enemy flag!",                          5   ,MSG_AUTO_GET_ENEMY_FLAG },
    { "Destroy the enemy generator!",                 6   ,0 },
    { "",                                             7   ,0 },
    { "Reinforce the offense!",                       8   ,0 },
    { "Destroy enemy sensors!",                       9   ,0 },
    { "Destroy enemy turrets!",                       10  ,MSG_AUTO_DESTROY_TURRETS },
    { "Destroy enemy vehicle!",                       11  ,0 },
    { "",                                             12  ,0 },
    { "Our base is clear.",                           13  ,0 },
    { "Enemy is in our base!",                        14  ,MSG_AUTO_ENEMY_IN_BASE },
    { "Retake our base!",                             15  ,0 },
    { "Our base is secure.",                          16  ,0 },
    { "Our base is taken!",                           17  ,0 },
    { "Defend our base!",                             18  ,0 },
    { "Cover our flag carrier!",                      19  ,MSG_AUTO_COVER_FLAG_CARRIER },
    { "Defend our entrances!",                        20  ,0 },
    { "Defend our flag.",                             21  ,MSG_AUTO_DEFEND_OUR_FLAG },
    { "Defend our generator!",                        22  ,0 },
    { "Cover me!",                                    23  ,MSG_AUTO_COVER_ME },
    { "",                                             24  ,0 },
    { "",                                             25  ,0 },
    { "Reinforce our defense!",                       26  ,0 },
    { "Defend our sensors!",                          27  ,0 },
    { "Defend our turrets!",                          28  ,0 },
    { "Defend our vehicle!",                          29  ,0 },
    { "Enemy base disabled.",                         30  ,MSG_AUTO_ENEMY_BASE_DISABLED },
    { "Enemy is disrupted. Attack!",                  31  ,0 },
    { "Enemy generator destroyed.",                   32  ,MSG_AUTO_GENERATOR_DESTROYED },
    { "Enemy remote equipment destroyed.",            33  ,MSG_AUTO_REMOTE_EQUIPMENT_DESTROYED },
    { "Enemy sensors destroyed.",                     34  ,MSG_AUTO_SENSORS_DESTROYED },
    { "Enemy turrets destroyed.",                     35  ,MSG_AUTO_TURRETS_DESTROYED },
    { "Enemy vehicle station destroyed.",             36  ,MSG_AUTO_VEHICLE_STATION_DESTROYED },
    { "I have the enemy flag.",                       37  ,MSG_AUTO_HAVE_FLAG },
    { "Give me the flag.",                            38  ,0 },
    { "",                                             39  ,0 },
    { "",                                             40  ,0 },
    { "Retrieve our flag.",                           41  ,MSG_AUTO_RETRIEVE_FLAG },
    { "Our flag is secure.",                          42  ,MSG_AUTO_FLAG_SECURE },
    { "Take the flag from me.",                       43  ,0 },
    { "Anytime.",                                     44  ,0 },
    { "I love it!",                                   45  ,MSG_AUTO_AWESOME },
    { "Bye.",                                         46  ,MSG_AUTO_BYE },
    { "Don't know.",                                  47  ,0 },
    { "Good game!",                                   48  ,MSG_AUTO_GOOD_GAME },
    { "Hi.",                                          49  ,MSG_AUTO_HI },
    { "No.",                                          50  ,0 },
    { "Oops.",                                        51  ,MSG_AUTO_OOPS },
    { "Quiet!",                                       52  ,0 },
    { "You rock!",                                    53  ,MSG_AUTO_YOU_ROCK },
    { "Shazbot!",                                     54  ,MSG_AUTO_SHAZBOT },
    { "Great shot!",                                  55  ,MSG_AUTO_AWESOME },
    { "Awww...too bad.",                              56  ,0 },
    { "HAHAHAHA!",                                    57  ,0 },
    { "I got your number! I got all your numbers!",   58  ,0 },
    { "Eat my plasma!",                               59  ,0 },
    { "Thanks.",                                      60  ,MSG_AUTO_AWESOME },
    { "Wait up.",                                     61  ,0 },
    { "Woohoo!",                                      62  ,MSG_AUTO_WOOHOO },
    { "Yes.",                                         63  ,0 },
    { "Need a bombardier.",                           64  ,0 },
    { "Need covering fire.",                          65  ,0 },
    { "Need a driver for ground vehicle.",            66  ,0 },
    { "Vehicle needs escort.",                        67  ,0 },
    { "Gunship ready, need a ride?",                  68  ,MSG_AUTO_GUNSHIP_READY },
    { "Hold that vehicle, I'm coming!",               69  ,0 },
    { "Need a pilot for turbo grav!",                 70  ,0 },
    { "I need a ride!",                               71  ,0 },
    { "Need vehicle support.",                        72  ,0 },
    { "Need a tailgunner!",                           73  ,0 },
    { "Where to?",                                    74  ,MSG_AUTO_WHERE_TO },
    { "Repair our base!",                             75  ,MSG_AUTO_REPAIR_BASE },
    { "Repair our generator!",                        76  ,MSG_AUTO_REPAIR_GENERATOR },
    { "Repair me!",                                   77  ,MSG_AUTO_REPAIR_ME },
    { "Repair our sensors!",                          78  ,MSG_AUTO_REPAIR_SENSORS },
    { "Repair our turrets!",                          79  ,MSG_AUTO_REPAIR_TURRETS },
    { "Repair our vehicle station!",                  80  ,MSG_AUTO_REPAIR_VEHICLE_STATION },
    { "I'll attack!",                                 81  ,MSG_AUTO_SELF_ATTACK },
    { "I'll attack the enemy base!",                  82  ,MSG_AUTO_SELF_ATTACK_BASE },
    { "I'll go for the enemy flag!",                  83  ,MSG_AUTO_SELF_ATTACK_FLAG },
    { "I'll attack the enemy generator!",             84  ,MSG_AUTO_SELF_ATTACK_GENERATOR },
    { "I'll attack the enemy sensors!",               85  ,MSG_AUTO_SELF_ATTACK_SENSORS },
    { "I'll attack the enemy turrets!",               86  ,MSG_AUTO_SELF_ATTACK_TURRETS },
    { "I'll attack the enemy vehicle station!",       87  ,MSG_AUTO_SELF_ATTACK_VEHICLE_STATION },
    { "I'll defend our base.",                        88  ,MSG_AUTO_SELF_DEFEND_BASE },
    { "I'm defending.",                               89  ,MSG_AUTO_SELF_DEFEND },
    { "I'll defend our flag.",                        90  ,MSG_AUTO_SELF_DEFEND_FLAG },
    { "I'll defend our generator.",                   91  ,0 },
    { "I'll defend our generator.",                   92  ,0 },
    { "I'll defend our sensors.",                     93  ,0 },
    { "I'll defend our turrets.",                     94  ,0 },
    { "I'll defend our vehicle station.",             95  ,0 },
    { "I'll repair our base.",                        96  ,MSG_AUTO_SELF_REPAIR_BASE },
    { "I'll repair our equipment.",                   97  ,MSG_AUTO_SELF_REPAIR_EQUIPMENT },
    { "I'll repair our generators.",                  98  ,MSG_AUTO_SELF_REPAIR_GENERATOR },
    { "I'm on repairs.",                              99  ,MSG_AUTO_SELF_REPAIR },
    { "I'll repair our sensors.",                     100 ,MSG_AUTO_SELF_REPAIR_SENSORS },
    { "I'll repair our turrets.",                     101 ,MSG_AUTO_SELF_REPAIR_TURRETS },
    { "I'll repair our vehicle station.",             102 ,MSG_AUTO_SELF_REPAIR_VEHICLE_STATION },
    { "I'll cover you.",                              103 ,MSG_AUTO_SELF_COVER_YOU },
    { "I'll deploy sensors.",                         104 ,MSG_AUTO_SELF_SET_UP_DEFENSE },
    { "I'm on it.",                                   105 ,0 },
    { "I'll deploy remote equipment.",                106 ,MSG_AUTO_SELF_DEPLOY_REMOTES },
    { "I'll deploy sensors.",                         107 ,MSG_AUTO_SELF_DEPLOY_SENSORS },
    { "I'll deploy turrets.",                         108 ,MSG_AUTO_SELF_DEPLOY_TURRETS },
    { "I'll get a vehicle ready.",                    109 ,0 },
    { "Target acquired.",                             110 ,MSG_AUTO_TARGET_ACQUIRED },
    { "Target the enemy base, I'm in position.",      111 ,0 },
    { "Target destroyed.",                            112 ,MSG_AUTO_TARGET_DESTROYED },
    { "Target their flag, I'm in position.",          113 ,0 },
    { "Need a target painted.",                       114 ,0 },
    { "Target their sensors, I'm in position.",       115 ,0 },
    { "Fire on my target.",                           116 ,0 },
    { "Target their turrets, I'm in position.",       117 ,0 },
    { "Wait, I'll be in range soon.",                 118 ,0 },
    { "Anytime.",                                     119 ,0 },
    { "Is our base secure?",                          120 ,0 },
    { "Cease fire!",                                  121 ,0 },
    { "No clue.",                                     122 ,0 },
    { "Help!",                                        123 ,MSG_AUTO_HELP },
    { "Move! Move! Move!",                            124 ,MSG_AUTO_MOVE },
    { "No.",                                          125 ,0 },
    { "Sorry.",                                       126 ,MSG_AUTO_SORRY },
    { "Thanks.",                                      127 ,0 },
    { "Wait up.",                                     128 ,0 },
    { "Yes.",                                         129 ,0 },
    { "Incoming bomber!",                             130 ,MSG_AUTO_WARN_BOMBER },
    { "Incoming hostiles!",                           131 ,MSG_AUTO_WARN_HOSTILES },
    { "Incoming vehicles!",                           132 ,MSG_AUTO_WARN_VEHICLES },
    { "Watch where you're shooting!",                 133 ,MSG_AUTO_WARN_FRIENDLY_FIRE }
};

#define NUM_MESSAGES (sizeof(Messages)/sizeof(audio_to_message))

//==============================================================================

xbool SendVoiceChatMessage( s32 PlayerID, s32 SfxID, u32 TeamBits )
{
    if( (SfxID >= 0) && (SfxID < NUM_MESSAGES) )
    {
        ASSERT( Messages[SfxID].SfxID == SfxID );

        if( Messages[SfxID].MessageID != 0 )
        {
            s32 Target;
            ...
            MsgMgr.Message( Messages[SfxID].MessageID, Target, ARG_WARRIOR, PlayerID );
            return TRUE;
        }
    }
    return FALSE;
...
void player_object::ApplyMove()
{
    ...
    if (tgl.pServer)
    {
        ...
        if (m_Move.NetSfxID)
        {
            ...
            {
                if( !SendVoiceChatMessage( m_ObjectID.Slot, m_Move.NetSfxID - GetVoiceSfxBase(), m_Move.NetSfxTeamBits ) )
        ...
        if( m_SpamTimer >= 10.0f )
            m_Muted = TRUE;

        m_SpamTimer = MAX( 0.0f, m_SpamTimer - m_Move.DeltaTime );
        ...
        */
        ...
        switch(m_Move.VoteType)
        {
            ...
            case VOTE_TYPE_CHANGE_MAP:
                GameMgr.InitiateMapVote( m_Move.VoteData, m_ObjectID.Slot );
             // GameMgr.CastVote( m_ObjectID.Slot, TRUE );
                break ;

            // Request that a player be kicked out of the game
            case VOTE_TYPE_KICK_PLAYER:
                GameMgr.InitiateKickVote( m_Move.VoteData, m_ObjectID.Slot );
             // GameMgr.CastVote( m_ObjectID.Slot, TRUE );
                break ;
...
void player_object::CheckForThrowingAndFiring( f32 DeltaTime )
{
    ...
    if ((tgl.ServerPresent) && (m_Health > 0))
    {
        ...
        if (m_Armed)
        {
            ...
            // Fire weapon?
            if ( (m_Armed) && (m_Move.FireKey) && (CanFire) && 
                 (m_WeaponFireDelay[ m_WeaponCurrentSlot ] == 0) )
            {
		        // Fire that weapon
        ...
        else
        {
            ...
            switch(m_PackCurrentType)
            {
                ...
                case INVENT_TYPE_ARMOR_PACK_SHIELD:
                    ...
                    {
                        // Activate?
                        if (m_Move.PackKey && (m_Energy >= 0.25f) )
                            SetPackActive(TRUE) ;
                    }
                    break ;
...
void player_object::UpdateDrawVars( void )
{
    ...
    // Make sure player instance is up to date ready for node v ray collision	
...
f32 player_object::Get3rdPersonView( vector3 &ViewPos, radian3 &ViewRot, f32 &ViewFOV ) const
{
    ...
    if( pVehicle )
    {
        ...
        radian3 r = radian3( R_0, m_CamTiltAng.Yaw, R_0 );
        matrix4 M( r );
        M  *= matrix4( Rot );
        Rot = M.GetRotation();
    }
...
xbool player_object::AddInvent(invent_type InventType, s32 Amount)
{
    ...
    if (LastCount != Count)
    {
        ...
        // If dropping a pack, maybe clear the current pack type.
        if( (bIsPack) && (GetInventCount( InventType ) == 0) )
    		SetPackCurrentType( INVENT_TYPE_NONE );
